...
public class HalamanTambahJadwalAnak extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halaman_tambah_jadwal_anak);
        ...
        tglortu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(HalamanTambahJadwalAnak.this, R.style.DialogTheme, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker datePicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        if (tanggalpilih < System.currentTimeMillis()) {
                            Toast.makeText(HalamanTambahJadwalAnak.this, "Tidak Ada Kegiatan", Toast.LENGTH_SHORT).show();
                        } else
        ...
        waktuortu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(HalamanTambahJadwalAnak.this, R.style.DialogTheme, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        mDatabase.child("tambahanakdariortu").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(HalamanTambahJadwalAnak.this, android.R.layout.simple_spinner_item, areas);
...
//                            startActivity(new Intent(getApplicationContext(), JadwalFragment.class));
                            Intent intent = new Intent(HalamanTambahJadwalAnak.this, HalamanPenjadwalanMandiri.class);
    ...
    private void photoBuilder() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HalamanTambahJadwalAnak.this);
        builder.setTitle("Lampirkan Foto");
        builder.setItems(options, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(HalamanTambahJadwalAnak.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            Toast.makeText(HalamanTambahJadwalAnak.this, "Foto gagal diambil, silahkan coba lagi", Toast.LENGTH_LONG).show();
        }
    }

    private void onCaptureImageResult(Intent data) {
        foto = Uri.fromFile(files);
        Picasso.with(HalamanTambahJadwalAnak.this).load(files).resize(imfoto.getWidth(), 500).centerCrop().into(imfoto);
    }
    ...
    private void onSelectFromGalleryResult(Intent data) {
        ...
        if (data != null) {
            ...
            Cursor cursor = HalamanTambahJadwalAnak.this.getContentResolver().query(selectedImage, filePathColumn, null, null, null);
            cursor.moveToFirst();
            ...
            Picasso.with(HalamanTambahJadwalAnak.this).load(file).resize(imfoto.getWidth(), 500).centerCrop().into(imfoto);
        }
    }
