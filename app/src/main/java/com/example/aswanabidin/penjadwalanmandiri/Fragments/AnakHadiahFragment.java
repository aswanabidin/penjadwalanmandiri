...
import com.example.aswanabidin.penjadwalanmandiri.Adapter.TambahHadiahAnakAdapter;
 ...
 */
public class AnakHadiahFragment extends Fragment {

    private Button btnambilhadiah;
    ...
    private TambahHadiahAnakAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_anak_hadiah, container, false);

        ButterKnife.bind(view);

        mAdapter = new TambahHadiahAnakAdapter(getContext());
