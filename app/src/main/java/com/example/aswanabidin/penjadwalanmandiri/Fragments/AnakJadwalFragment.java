...
public class AnakJadwalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_anak_jadwal, container, false);

        ButterKnife.bind(view);

        mAdapter = new TambahJadwalAnakAdapter(getContext());
        recyclerView = (RecyclerView) view.findViewById(R.id.listJadwalAnakOrtu);
        recyclerView.setAdapter(mAdapter);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        cardView = (CardView) view.findViewById(R.id.cardview_selesaijadwalanak);
