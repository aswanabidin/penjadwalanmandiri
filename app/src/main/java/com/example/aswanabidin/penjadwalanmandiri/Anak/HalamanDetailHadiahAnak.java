...
import com.example.aswanabidin.penjadwalanmandiri.OrangTua.HalamanEditHadiahOrtu;
...
public class HalamanDetailHadiahAnak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halaman_detail_hadiah_anak);
        ...
        btnedithadiah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HalamanDetailHadiahAnak.this, HalamanEditHadiahOrtu.class);
        ...
        btnhapushadiah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(HalamanDetailHadiahAnak.this);
...
//                                database.getReference().removeValue();
                                startActivity(new Intent(HalamanDetailHadiahAnak.this, HalamanPenjadwalanMandiri.class));
